...
define([
    ...
    var RectangleChoiceStateQuestion = stateFactory.extend(QuestionState);

    RectangleChoiceStateQuestion.prototype.createToolbar = function () {
    ...
    return RectangleChoiceStateQuestion;
});
